/* @ts-self-types="./chops_search_wasm.d.ts" */
...
export class Engine {
     ...
     */
    best_chunk(id) {
        const ret = wasm.engine_best_chunk(this.__wbg_ptr, id);
        return ret >>> 0;
    }
    /**
     ...
     */
    chunk_count() {
        const ret = wasm.engine_chunk_count(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    dim() {
        const ret = wasm.engine_dim(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} id
     ...
     */
    doc_title(id) {
        const ret = wasm.engine_doc_title(this.__wbg_ptr, id);
        let v1;
        if (ret[0] !== 0) {
     ...
     */
    doc_url(id) {
        const ret = wasm.engine_doc_url(this.__wbg_ptr, id);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    ...
    ingest(byte_start, bytes) {
        ...
        const ret = wasm.engine_ingest(this.__wbg_ptr, byte_start, ptr0, len0);
        if (ret[1]) {
    ...
    plan(query) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_plan(this.__wbg_ptr, ptr0, len0);
     ...
     */
    prefix_rows() {
        const ret = wasm.engine_prefix_rows(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    search(query, limit) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.engine_search(this.__wbg_ptr, ptr0, len0, limit);
     ...
     */
    used_semantic() {
        const ret = wasm.engine_used_semantic(this.__wbg_ptr);
        return ret !== 0;
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./chops_search_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('chops_search_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
